...
| 配置项 | 值 |
|-------|---|
| API Key | `sk-14b1cb4072a24f9b9ee55d95977d1e98` |
...
| 配置项 | 值 |
|-------|---|
| API Key | `sk-caed24c0213947838ff9c4ff4c5883f0` |
...
|----------|---------|------|--------|
| 阿里云通义千问 | `sk-14b1cb4072a24f9b9ee55d95977d1e98` | ✅ 已验证 | ⭐⭐⭐⭐ |
| DeepSeek | `sk-caed24c0213947838ff9c4ff4c5883f0` | ✅ 已验证 | ⭐⭐⭐⭐⭐ |
| 火山引擎豆包 | `b91ae0e0-85a5-4e10-8297-4b05fd670fe6` | ✅ 已验证 | ⭐⭐⭐⭐ |
