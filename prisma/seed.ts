...
async function main() {
  ...
  // ⚠️ Admin password should come from environment variable in production
  const adminPassword = process.env.ADMIN_PASSWORD || 'REDACTED_PASSWORD'; // Default for development only
